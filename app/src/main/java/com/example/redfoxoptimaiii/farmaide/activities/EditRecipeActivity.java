        ...
        spinner_animal.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (spinner_animal.getSelectedItemPosition()) {
                    case 0:
                        adapter = ArrayAdapter.createFromResource(EditRecipeActivity.this, R.array.poultry_types, android.R.layout.simple_spinner_item);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        spinner_animal_type.setAdapter(adapter);
                        break;
                    case 1:
                        adapter = ArrayAdapter.createFromResource(EditRecipeActivity.this, R.array.swine_types, android.R.layout.simple_spinner_item);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        spinner_animal_type.setAdapter(adapter);
                        break;
                    case 2:
                        adapter = ArrayAdapter.createFromResource(EditRecipeActivity.this, R.array.ruminants_type, android.R.layout.simple_spinner_item);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        spinner_animal_type.setAdapter(adapter);
                        break;
                }
