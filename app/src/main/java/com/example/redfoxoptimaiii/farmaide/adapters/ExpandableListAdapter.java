...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (contacts != null)
                convertView = inflater.inflate(R.layout.supplier_list_header, null);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            if (contacts != null)
                convertView = inflater.inflate(R.layout.supplier_list_group_item, null);
    ...
    public List getCheckedGroup(String groupName) {
        return checkedItems.get(groupName);
    }
