    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (getItemViewType(position)) {
            ...
            case ANIMAL:
                ...
                if (list.get(position).equals("Poultry"))
                    image.setImageResource(R.drawable.poultry);
                else if (list.get(position).equals("Ruminants"))
                    image.setImageResource(R.drawable.ruminants);
                else if (list.get(position).equals("Swine"))
                    image.setImageResource(R.drawable.swine);
                break;
            case ANIMAL_TYPE:
