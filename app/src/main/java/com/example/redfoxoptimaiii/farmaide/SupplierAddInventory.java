...
public class SupplierAddInventory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.supplier_add_inventory);
    ...
    public void addInventory(View view){
        ...
        if (!check) Toast.makeText(this, "Please fill out all the fields", Toast.LENGTH_SHORT).show();
            ...
            try{
                ...
                if(check){
                    ((FarmAideDatabaseHelper)FarmAideDBHelper).insertFeed(db, Supplier.farm_id,feed_type,feed_name,Double.parseDouble(dm),
                    ...
                    intent.putExtra("username", Supplier.username);
                    intent.putExtra("farm_id", Supplier.farm_id);
