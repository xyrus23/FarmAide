...
public class PredictorInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.predict_layout).setVisibility(View.GONE);
    }
    ...
    public void predict(View view) {
        ...
        if (input[0].isEmpty() || input[1].isEmpty() || input[2].isEmpty() || input[3].isEmpty())
            ...
            ((TextView) findViewById(R.id.predicted_output)).setText(pvalue + "kg");
            ((TextView) findViewById(R.id.adj_r_squared)).setText(rvalue + "%");
            if (adj_r_squared > 50)
                ((TextView) findViewById(R.id.adj_r_squared)).setTextColor(getResources().getColor(R.color.colorPrimary));
